...
namespace Shopiround.Migrations
{
    ...
    [Migration("20231129152824_nihal1")]
    partial class nihal1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopiround.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.SavedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.Shop", b =>
                {
                    b.Property<int>("ShopId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.Statistics.KeywordsCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KeywordsCounts");
                });

            modelBuilder.Entity("Shopiround.Models.Statistics.ProductCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopiround.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Shopiround.Models.Product", b =>
                {
                    b.HasOne("Shopiround.Models.Shop", "Shop")
                        .WithMany()
            ...
            modelBuilder.Entity("Shopiround.Models.Shop", b =>
                {
                    b.HasOne("Shopiround.Models.ApplicationUser", "applicationUser")
                        .WithOne("Shop")
                        .HasForeignKey("Shopiround.Models.Shop", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
